...
nothing. Filling half the schedule instead measured \textbf{2.0x} on that
model at \texttt{maxm=60} (50.5\,s flat vs 24.9\,s ramped, same energy to
$8\times10^{-9}$; BLAS pinned to one thread on two dedicated cores, as any
timing in this repo must be).
