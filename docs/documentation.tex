...
energies alone previously discarded. Nothing consumes them yet; they are
what a spectral weight $\langle\Psi|O|\Phi_k(B)\rangle$ would be built
from. This is \texttt{pyitensor}-only: the \texttt{itensor\_version=3}
