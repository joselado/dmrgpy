...
$\sim$2.5--3x slower than \texttt{"python"} at both \texttt{n\_uc=1} and
\texttt{n\_uc=2}, with energy-density agreement between the two backends
to $\sim$1e-8. \texttt{Chain::idmrg\_ground\_state} is reached by
constructing a \texttt{Chain} directly from the unit cell's own
