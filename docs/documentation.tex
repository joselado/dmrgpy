...
Python. Cross-site correlators of fermionic operators are a separate,
still-unthreaded code path and are refused outright --- see
\texttt{Infinite\_Many\_Body\_Chain.correlator}'s own guard.
