...
\texttt{vev}/\texttt{correlator}/\texttt{excitation\_energies}/
\texttt{excitation\_gap}/\texttt{local\_excitation\_gap} all remain
\texttt{gs\_method="idmrg"}-only, mirroring the precedent
