...
9.3\,s $\to$ 1.7\,s under \texttt{itensor\_version=3} and 37.7\,s $\to$
5.1\,s under \texttt{"python"}, against \texttt{ctmode="full"} at
5.8--8.1$\times$ slower on the sizes the
\texttt{four\_correlation\_tensor\_sweep\_VS\_full} example measures.
