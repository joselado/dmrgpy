...
re-solving against $e^{i\theta}H$ for a small $\theta$, which leaves
every eigenvector untouched and rotates the spectrum just enough to
separate the pair's real parts. Neither adaptation is observable on a
