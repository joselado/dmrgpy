// In-process Python/C++ interface (see the "in-memory transfer" migration
// plan). Phase 1 established the build scaffold (version()/
// itensor_smoke_test(), kept below). This adds the Phase 2/3 slice:
// ground state energy, generic VEV, and apply-operator, wired up through
// the Chain session class -- the template the rest of the migration copies.
