...
def stochastic_inverse_trace(self,A,n=10,mode="DMRG",**kwargs):
...
#    wfs = [random_state(self,mode=mode).normalize() for i in range(n)] # states
    wBw = [wf.dot(self.applyinverse(A,wf)) for wf in wfs] # inverses
